...
var se_Event_Search   = ' AND ("Received webhook event from intellihr event:" OR "Completed webhook event from intellihr event:")'
var se_Papi           = ' AND ("Received webhook event from intellihr event:" OR "Completed webhook event from intellihr event:")'
...
parr('Get HR Event', ['"', hp, '" AND "hris-webhook:" AND "environment HR Event is"', c()]) ++ 

parr('Event Search', ['"', hp, '" AND "Received webhook event from intellihr event:" AND (', pje(), ')', f(se_Event_Search)]) ++ 
